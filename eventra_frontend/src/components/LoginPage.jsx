...
export default function LoginPage({ setIsLoggedIn }) {
  ...
  const handleForgotPassword = (e) => {
    e.preventDefault();
    if (!email) {
      setErrors({ email: 'Please enter your email to request password reset' });
      return;
    }
    ...
    setTimeout(() => {
      setIsLoading(false);
      setStatus('success');
      setStatusMsg(`Password reset instructions sent to ${email} (Simulated).`);
      setAlertVisible(true);
    }, 1000);
  };
  ...
  return (
    <div className="min-h-[80vh] bg-slate-50 flex items-stretch font-outfit overflow-hidden">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row shadow-2xl mt-1 mb-6 lg:mt-2 lg:mb-10 rounded-3xl overflow-hidden bg-white">
          ...
          <div className="relative z-10 my-10 lg:my-0 flex-1 flex flex-col justify-center">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-emerald-100/90 text-sm sm:text-base leading-relaxed text-justify mb-8">
                Sign in to your Eventra account and continue discovering amazing events, managing registrations, verifying certificates, and connecting with your community.
              </p>
            </div>
        ...
        {/* Right Side: Login Form (45% on Desktop) */}
              ...
              <div className="flex items-center justify-between text-sm pt-1">
                <label className="flex items-center space-x-2 cursor-pointer select-none">
                  <input
                    ...
                    disabled={isLoading}
                    className="h-4 w-4 rounded border-slate-300 text-[#2E6F40] focus:ring-[#2E6F40] cursor-pointer"
                  />
                  <span className="font-semibold text-slate-600 text-xs sm:text-sm">Remember Me</span>
                </label>
