          ...
          {CORE_SERVICES.map((srv, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="pt-6">
                  <button className="w-full py-2.5 px-4 bg-slate-900 hover:bg-black text-white text-xs font-bold rounded-xl transition-all duration-300 transform active:scale-98 cursor-pointer flex items-center justify-center space-x-1">
          ...
          {PORTFOLIO_PROJECTS.map((pj, idx) => (
            ...
            >
              ...
              <div className="px-6 pb-6">
                <button className="w-full py-2.5 bg-slate-50 hover:bg-slate-900 hover:text-white text-gray-800 text-xs font-bold rounded-xl transition-colors cursor-pointer text-center">
                  View Case Study
                </button>
              </div>
